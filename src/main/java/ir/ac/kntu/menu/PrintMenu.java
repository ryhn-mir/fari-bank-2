...
//    public static void printUserRegistrationCustomerMenu() {
...
//
//    }
//    public static void printTransferMoneyMenu() {
//        System.out.println(Constant.BLUE + "choose one of the following option");
...
//        System.out.println(Constant.GREEN + "99.back");
//    }
//    public static void printManageAccountMenu() {
//        System.out.println(Constant.BLUE + "choose one of the following option");
...
//    public static void printRequestTransactions() {
//        System.out.println(Constant.BLUE + "choose one of the following option");
